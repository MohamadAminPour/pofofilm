      ...
      <div class="dashboard-content">
        <div class="comments">
          <div class="comments-header" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="0">
            <img src="../assets/images/icons8-message-100.png" alt="" />
            <p class="comments-header-title">کامنت ها</p>
            <p class="comments-header-subTitle">
              کامنت های کاربران زیر محتوا های پوفوفیلم !
            </p>
          </div>
          <hr />
            ...
            <li>
              ...
              <button class="comments-action">
                ...
                <ul class="comments-action__wrench">
                  ...
                  <li><a href="./submitComment.php?id=<?= $comment['id'] ?>">تایید</a></li>
                  <li><a href="./rejectComment.php?id=<?= $comment['id'] ?>">رد</a></li>
                </ul>
              </button>
            </li>
            <?php endforeach;} else{ ?>
