<?php
  ...
  $query=$conn->prepare("SELECT * FROM tickets WHERE status=?");
  $query->bindValue(1, 0);
  $query->execute();
      ...
      <div class="dashboard-content">
        <div class="comments">
          <div class="comments-header" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="0">
            <img src="../assets/images/icons8-ticket-100 (2).png" alt="" />
            <p class="comments-header-title">تیکت ها</p>
            <p class="comments-header-subTitle">
              تیکت های خوانده نشده را میتوانید مشاهده کنید !
            </p>
          </div>
          <hr />
          <ul class="comments-infos" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
            ...
            <li>
              ...
              <button class="comments-action">
                ...
                <ul class="comments-action__wrench">
                  <li><a href="#" onclick="alert('<?= $ticket['content'] ?>')">نمایش</a></li>
                  <li><a href="./tickets-read.php?id=<?= $ticket['id'] ?>">خوانده شد</a></li>
                </ul>
              </button>
            </li>
            <?php endforeach;} else{ ?>
            <div class="empty-msg">
                <p
                  ...
                  data-aos-delay="0"
                >
                  تا به امروز تیکتی از سمت کاربرات ارسال نشده است .
                </p>
              </div>
              <?php } ?>
          </ul>
