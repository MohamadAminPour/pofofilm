...
<body>
  ...
  <div class="video-container">
    ...
    <div class="accordion movie-playOnline__accordion" id="accordionExample">
          ...
          <div class="accordion-body">
            ...
            <div class="accordion-series">
              <div class="accordion-series__item">
                ...
                <ul>
                  <li>
                    <i class="bx bx-play" style="margin: 1px;"></i>
                    <a href="">نمایش</a>
                  </li>
                </ul>
              </div>
      ...
      <div class="accordion-item">
        ...
        <div id="collapse2" class="accordion-collapse collapse" aria-labelledby="heading2"
          ...
          <div class="accordion-body">
            <div>
              <i class="bx bx-lock-alt"></i>
              <p>برای تماشا باید اشتراک داشته باشید.</p>
            </div>
            <!-- <div>
              <i class="bx bx-play"></i>
              <a href="">کیفیت 480</a>
